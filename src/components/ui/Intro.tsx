...
export const Intro: React.FunctionComponent = () => {
  return (
    <div className="mx-auto text-[#fff] md:border-2 border-red-500">
          <div className='relative w-[20rem] sm:w-[30rem] md:border-2 md:w-[46.625rem] lg:w-[48rem] bord md:h-[7.8125rem] mx-auto uppercase'>
            ...
            <div className='spin-text-container flex justify-start smgap-1 lg:justify-center md:w-[48.2rem] border2 border2 h-[30px] md:h-[60px] intro text-[2rem] md:text-[3.25rem] leading-[120%]'>

              <h1 className='intro textcenter md:text-start hidden lg:block'>into Digital</h1>
              <div className='word text-start border-2'>
                <span
