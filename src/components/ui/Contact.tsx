...
const socials = [
  {
    label: "GitHub",
    handle: "@amjido-01",
    href: "https://github.com/amjido-01/",
    icon: (
  ...
  {
    label: "LinkedIn",
    handle: "abubakar-muhammad-ala",
    href: "https://www.linkedin.com/in/abubakar-muhammad-ala/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: "Phone",
    handle: "+234 703 817 2450",
    href: "tel:+2347038172450",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: "Facebook",
    handle: "Abubakar A M Jido",
    href: "https://web.facebook.com/profile.php?id=100075080807782",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
