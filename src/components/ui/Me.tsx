...
export const Me: React.FunctionComponent = () => {
  // component code
  return (
    <main className="mt-[15rem] sm:mt-[10rem] md:mt-[15rem] ">
      ...
      <div className="mx-auto w-[85%] sm:w-[90%] lg:w-[85%] flex flex-col gap-[5rem] lg:flex-row justify-center lg:gap-[7.5rem] items-center lg:h-[31.0006rem]">
        {/* photo*/}
        <div className="w-[90%] sm:w-[90%] md:w-[78%] lg:w-[26.00006rem] aspect-square rounded-full overflow-hidden">
          <TiltEffect>
            <img
              src={ala}
              className="mx-auto cursor-pointer w-full h-full object-cover"
              alt="my pic"
            />
          </TiltEffect>
        </div>
