    ...
    <section className='border-2 h-[30re mt-[10rem] md:mt-[15rem] overflow-hidden'>
        ...
        <div className='w-[90%] md:w-[85%] lg:w-[30.00006rem]'>
          ...
          <div className='w-full md:w-[85%] lg:w-[30.00006rem]'>
            <div className="content capitalize leading-normal">
              <h1 className='montserrat border-2 text-[#fff] text-[1.5rem] md:text-[2.25rem] style font-bold leading-normal capitalize'>Hi there, I’m Ala jido </h1>

              <p className='border-2 Poppins text-[#ccc] text-[0.875rem] md:text-[1.25rem] font-normal capitalize md:my-[1.88rem]'>Frontend Developer and Computer Science Student with over 2 years of experience. Specializing in ReactJS, I'm committed to crafting cutting-edge, user-centric interfaces, prioritizing accessibility. Let's collaborate to bring your vision to life – your vision, my expertise.</p>
            </div>
