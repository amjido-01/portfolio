/**
 * LgDownArrow is a React component that renders an animated down arrow SVG.
 * It takes in SVGProps and renders a circle with a bouncing animated path inside.
 */
