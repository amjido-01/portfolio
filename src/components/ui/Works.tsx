  ...
  return (
    <div className="my-[12rem] md:my-[8.75rem] mb-20">
      <div className="w-[85%] mx-auto">
        ...
        <div className="lg:flex-row lg:gap-[2.06rem] flex flex-col gap-[2.06rem] sm:gap-[10rem] md:gap-[2.06rem] justify-center items-center">
          {/* Image list */}
          <motion.div
            key={selectedProject}
          ...
          {/* Description list */}
          <div className="w-[95%] lg:w-[55%] border2 ml-2 md:ml-0 md:mx-auto md:w-[95%] gap-3 lg:gap-10 h-[24.375rem] md:h-[32rem]  flex mt[2.06rem]">
            {/* Description */}
